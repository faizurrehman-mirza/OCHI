...
function LandingPage() {
  return (
    <div className='w-full h-screen font-founder pt-2 '>
      <div className='textstructure mt-40'>
        <div className='masker px-22'>
          <h1 className='text-8xl uppercase font-semibold tracking-tighter leading-[7vw] '>we create</h1>
        </div>
         <div className='masker px-22 flex items-center gap-3'>
          <div className='bg-red-700 w-[8vw] h-[5.5vw] rounded-xl '></div>
          <h1 className='text-8xl uppercase font-semibold tracking-tighter leading-[7vw] '>eye-opening</h1>
        </div>
         <div className='masker px-22'>
          <h1 className='text-8xl uppercase font-semibold tracking-tighter leading-[7vw] '>presentations</h1>
        </div>
      </div>
...
<div className='bottom w-full flex items-center justify-between'>
  <div className='w-[70%] flex items-center justify-between mt-5 px-10  '>
    {["Presentation and storytelling agency","For innovation teams and global brands"].map((item,index)=> <p className='font-light ' key={index}>{item}</p>)}
  </div>
